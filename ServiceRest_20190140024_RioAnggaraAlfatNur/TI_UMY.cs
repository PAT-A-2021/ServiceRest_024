...
namespace ServiceRest_20190140024_RioAnggaraAlfatNur
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source = LAPTOP-214BN04U; Initial Catalog = \"TI UMY\"; Persist Security Info = True; User ID = sa; Password = Salr8301");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source = LAPTOP - 214BN04U; Initial Catalog = \"TI UMY\"; Persist Security Info = True; User ID = sa; Password = Salr8301");
